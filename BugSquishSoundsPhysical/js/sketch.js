...
function draw() {
  ...
  buttonVal = sensor.buttonV; //
console.log(buttonVal);


if (buttonVal == 1 && currentBV == 0){//
  currentBV = 1;
  mousePressed();
  mouseIsPressed = true;  
}
else if (buttonVal == 0 && currentBV == 1){
  currentBV = 0;
}
...
//
  ...
  ellipse(sensor.ellipseX, sensor.ellipseY, 55, 55);
...
class Character{
  ...
  draw(){
    ...
    squishCheck(){
      let d = -1;
      if (sensor.ellipseX > this.x - 40 && sensor.ellipseX < this.x + 40 && sensor.ellipseY > this.y - 40 && sensor.ellipseY < this.y + 40){
        d = dist(sensor.ellipseX, mouseY, this.x, this.y)
      }
      return d
    }
    squish(){
